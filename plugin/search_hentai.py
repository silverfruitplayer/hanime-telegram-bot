...
async def hentaisearch(_, message):
    msg = message.text
    msgSplit = msg.split(" ")
    ...
    if query == "":
        client.send_animation(chat_id=message.chat_id,
        ...
        if keyb == []:
            ...
            await message.reply_text(f"Your Search Results for **{query}**", reply_markup=repl, parse_mode="markdown")
